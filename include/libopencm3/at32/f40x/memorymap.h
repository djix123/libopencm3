...
/* --- AT32F40x specific peripheral definitions ---------------------------- */
...
#define SPI4_BASE			(PERIPH_BASE_APB1 + 0x4000)
...
#define USB_PMA1_BASE			(PERIPH_BASE_APB1 + 0x6000)
...
#define USB_PMA2_BASE			(PERIPH_BASE_APB1 + 0x7800)
/* PERIPH_BASE_APB1 + 0x8400 (0x4000 8400 - 0x4000 FFFF): Reserved */
...
/* RESERVED GPIO_PORT_F_BASE		(PERIPH_BASE_APB2 + 0x1c00) */
/* RESERVED GPIO_PORT_G_BASE		(PERIPH_BASE_APB2 + 0x2000) */
...
/* RESERVED TIM15_BASE			(PERIPH_BASE_APB2 + 0x4000) */
/* RESERVED TIM16_BASE			(PERIPH_BASE_APB2 + 0x4400) */
/* RESERVED TIM17_BASE			(PERIPH_BASE_APB2 + 0x4800) */
...
#define CRS_BASE			(PERIPH_BASE_APB2 + 0x5800)
#define I2C3_BASE			(PERIPH_BASE_APB2 + 0x5c00)
#define USART6_BASE			(PERIPH_BASE_APB2 + 0x6000)
